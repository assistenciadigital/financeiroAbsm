...
<header>
	   	<div class="row">
				<div class="form-group col-md-1">
					<?php $titular = @mysql_fetch_assoc(mysql_query("SELECT cliente, nome, datanascimento FROM cliente WHERE cliente = '".$_GET['titular']."'"));?>
					<label>Id</label>
				...
				<div class="form-group col-md-6">
				 <label>Nome Titular</label>
				  <input type="text" disabled class="form-control" id="nome" name="nome" placeholder="Nome" value="<?php echo $titular['cliente'].' - '.$titular['nome'];?>" required>
				</div> 
...
<div class"container">
    <div class="row">
        ...
        <div class="col-md-9 text-right h5">
            Por:
			...
			<?php if ($_GET['porano']){?>
			<a class="btn btn-info" <?php if (($menu >= 1) AND ($menu <= 5)){?>href="<?php if ($_GET['porano']) echo 'quitacao.php?titular='.$_GET['titular'].'&porano='.$_GET['porano']?>" target="_blank"<?php }?>><i class="fa fa-file-pdf-o"></i> Quitacao</a>
			...
			<a class="btn btn-info" <?php if (($menu >= 1) AND ($menu <= 5)){?>href="<?php if ($_GET['porano']) echo 'recibo.php?titular='.$_GET['titular'].'&porano='.$_GET['porano']?>" target="_blank"<?php }?>><i class="fa fa-file-pdf-o"></i> Recibo</a>
...
<tbody>
	<tr <?php if ($dados['recebimento'] and $dados['valor_recebimento'] and $dados['evento']) echo "bgcolor=success"; else echo "bgcolor=danger";?>>
		...
		<td class="actions text-right">
			<a href="<?php if (($menu >= 1) AND ($menu <= 5)) echo 'add_recebimento.php?id='.$dados['mensalidade'].'&titular='.$dados['titular']; ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-usd"></i></a>
