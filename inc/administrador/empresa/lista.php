    ...
    <div class="row">
        ...
        <div class="col-md-6 text-right h5">
            ...
            <select class="selectpicker" name="pesquisarpor" id="pesquisarpor" onchange="atualiza()">
                  ...
                  <option value="menu"<?php  if($_GET['pesquisarpor'] == 'menu')  echo "selected"?>>Menu</option>
                  <option value="submenu"<?php  if($_GET['pesquisarpor'] == 'submenu')  echo "selected"?>>Sub-Menu</option>
                  <option value="descricao"<?php  if($_GET['pesquisarpor'] == 'descricao')  echo "selected"?>>Descricao</option>
                  <option value="link"<?php  if($_GET['pesquisarpor'] == 'link')  echo "selected"?>>Link</option>
                  <option value="arquivo"<?php  if($_GET['pesquisarpor'] == 'arquivo')  echo "selected"?>>Arquivo</option>
            </select>
             Registros por página:
...
<thead>
	<tr vertical-align: middle;>
		<th width="5%">ID</th>
		<th width="50%">CPF/CNPJ | Nome Fantasia | Razao Social</th>
        <th width="20%">Responsavel/Funcao</th>
		<th width="10%">Atualizado / Por</th>
...
<tbody>
	<tr>
		...
		<td><?php echo $dados['cpf_cnpj'].' - '.$dados['fantasia'].'<br/>'.$dados['razao']; ?></td>
		<td><?php echo $dados['responsavel'].'<br/>'.$dados['funcao']; ?></td>
