...
<header>
	<div class="row">
		<div class="col-sm-12 h2">
			<?php if ($_GET['usuario_login']){echo 'Tabela: Usuario - Editar Registro: ID [ '.$_GET['usuario_login'].' ]';}?>
		</div>

	</div>
</header>
  <form data-toggle="validator" action="run.php?acao=edicao&usuario_login=<?php echo $_GET['usuario_login'];?>" method="post">
    <div class="row">
  	...
  	<div class="row">
	    ...
	    <div class="form-group col-md-5">
  	     <label>Nome</label>
  	  	  <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome" value="<?php echo $dados['usuario_nome']?>" required autofocus>
  	    </div>
        
	    <div class="form-group col-md-2">
  	     <label>Data Nascimento</label>
  	  	  <input type="date" class="form-control" id="nascimento" name="nascimento" placeholder="Data Nascimento" value="<?php echo $dados['usuario_nascimento']?>" required>
  	    </div>
     ...
     <div class="row">
	    ...
	    <div class="form-group col-md-4">
  	     <label>E-mail</label>
  	  	  <input type="email" class="form-control" id="email" name="email" placeholder="email" value="<?php echo $dados['usuario_email']?>" required>
  	    </div>         

        <div class="form-group col-md-2">
  	     <label>Telefone</label>
  	  	  <input type="tel" class="form-control" id="telefone" name="telefone" placeholder="Telefone" value="<?php echo $dados['usuario_telefone']?>" required>
  	    </div>    
         
        <div class="form-group col-md-2">
  	     <label>Celular</label>
  	  	  <input type="tel" class="form-control" id="celular" name="celular" placeholder="Celular" value="<?php echo $dados['usuario_celular']?>" required>
  	    </div>  
