    ...
    <div class="row">
        ...
        <div class="col-md-6 text-right h5">
            ...
            <select class="selectpicker" name="pesquisarpor" id="pesquisarpor" onchange="atualiza()">
                  ...
                  <option value="hora"<?php  if($_GET['pesquisarpor'] == 'hora')  echo "selected"?>>Data / Hora</option>
                  <option value="ip"<?php  if($_GET['pesquisarpor'] == 'ip')  echo "selected"?>>IP</option>
                  <option value="usuario"<?php  if($_GET['pesquisarpor'] == 'usuario')  echo "selected"?>>Usuario</option>
                  <option value="mensagem"<?php  if($_GET['pesquisarpor'] == 'mensagem')  echo "selected"?>>Mensagem</option>
            </select>
             Registros por página:
...
<table class="table table-hover table-layout: fixed table-condensed table-bordered h6">
<thead>
...
<tbody>
	<tr>
		...
		<td><?php echo datetime_datatempo($dados['hora']); ?></td>
